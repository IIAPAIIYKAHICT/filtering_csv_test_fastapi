...
from utils.utils import initialize_qdrant_client
...
async def vacancies_page(
    ...
    if search:
        records, total_pages = filter_and_sort_jobs(job_data, search, sort_by, order, page, page_size)
    else:
        records, total_pages = filter_and_sort_jobs(job_data, None, sort_by, order, page, page_size)
